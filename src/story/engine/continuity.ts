...
function englishTerms(value: string): string[] {
  const generic = new Set(['with', 'from', 'into', 'about', 'around', 'again', 'next', 'current', 'situation', 'continue', 'inspect', 'observe', 'check', 'ask', 'tell', 'help', 'return', 'follow', 'leave', 'wait', 'take', 'make', 'try', 'use', 'look', 'move', 'join', 'finish', 'decline', 'accept', 'agree', 'choose', 'rent', 'stay', 'begin', 'start', 'flatten', 'pocket', 'trace', 'discuss', 'investigate', 'survey', 'push', 'brace', 'block', 'lock', 'guard', 'hold'])
