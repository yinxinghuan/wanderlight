  ...
  return <header className="st-chat-header">
    <div className="st-chat-header__top">
      ...
      <div className="st-chat-header__actions">
        ...
        <button className="st-world-button st-world-button--relations" onClick={() => openWorld('party')} aria-label={t(cartridge.locale, 'world')} title={t(cartridge.locale, 'world')}><Icon name="people" /><span>{t(cartridge.locale, 'relationshipShortcut')}</span></button>
      </div>
    </div>
