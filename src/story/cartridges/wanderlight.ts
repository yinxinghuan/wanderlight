...
function make(locale: Locale): StoryCartridge {
  ...
  return {
    ...
    statDefinitions: [{ id: 'energy', label: s('精力', 'Energy'), min: 0, max: 100, initial: 72, display: 'bar', inverse: true, warningAt: 28, dangerAt: 8, maxDelta: 24 }, { id: 'coin', label: s('钱币', 'Coins'), min: 0, max: 999, initial: 6, display: 'number', unit: s('枚', ''), description: s('通用钱币。普通车票 3 枚，热饭 4 枚，客房 10 枚；工作结清时增加。', 'Everyday money. Regular ticket 3, hot meal 4, room 10; paid work adds coins.'), inverse: true, warningAt: 3, dangerAt: 0, maxDelta: 30 }, { id: 'renown', label: s('风闻', 'Standing'), min: -40, max: 100, initial: 4, display: 'bar', inverse: true, warningAt: -10, dangerAt: -30, maxDelta: 18 }],
