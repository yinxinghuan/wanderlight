...
const dictionary = {
  zh: {
    ...
    retry: '重试',
    retryAction: '重试这一步',
    consistencyRecovery: '你重新确认了眼前的情况，没有把不确定的消息写进旅途记录。{name}的一切仍在继续。',
    summary: '阶段小结 · 已保存',
  ...
  en: {
    ...
    consistencyRecovery: 'You check the situation again without adding uncertain details to the journey record. Life at {name} continues around you.',
