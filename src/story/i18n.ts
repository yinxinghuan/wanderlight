...
const dictionary = {
  zh: {
    ...
    consistencyRecoveryConfirmed: '你停止追着矛盾的指引打转，重新查看{name}眼下确实可做的事情。没有可靠的新事实需要写入记录；“{action}”仍可重新尝试，也可以先处理当前可执行的行动。',
  ...
  en: {
    ...
    consistencyRecoveryConfirmed: 'You stop circling the conflicting directions and review what is genuinely possible at {name}. No reliable new fact needs recording; you may retry “{action}” or take an immediately workable action.',
